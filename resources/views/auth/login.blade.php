                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                             <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="{{asset('img/holo.png')}}" alt="...">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small text-gray-300" href="{{ route('password.request') }}">Forgot Password?</a>
                                </div>
                                <div class="text-center">
                                    <a class="small text-gray-300" href="{{ route('register') }}">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
